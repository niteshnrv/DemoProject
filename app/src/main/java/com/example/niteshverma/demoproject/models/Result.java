package com.example.niteshverma.demoproject.models;
...
public class Result {
    ...
    @Expose
    private DateOfBirth registered;
    ...
    public DateOfBirth getRegistered() {
        return registered;
    }

    public void setRegistered(DateOfBirth registered) {
